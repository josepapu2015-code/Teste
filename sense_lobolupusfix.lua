...
-- DonatorFix
-- Autor: LoboLupus
-- Sense com SETA (FINAL FIX)
-----------------------------

setDefaultTab("Sense")
cor = UI.Button("- Sense com seta -", scpPanel5)
cor:setColor("#FFFAFA")

-- =========================
-- AJUDA UI
-- =========================
local lbl = addLabel("COMO USAR", "COMO USAR")
lbl:setColor("#FF0000")
UI.Label("xNick")
UI.Label("T (ultimo target)")
UI.Label("V (ultimo sense)")

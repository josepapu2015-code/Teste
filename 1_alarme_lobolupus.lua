...
if not storage[panelName] then
  storage[panelName] = {
    ...
    privateMessage = false,   -- toca Private_Message
    playerpk = false,         -- toca alarm.ogg
    creatureDetected = false, -- toca Creature_Detected.ogg
  }
end
